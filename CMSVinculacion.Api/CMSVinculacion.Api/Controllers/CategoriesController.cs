...

{
...

    {
        ...
        /// <summary>Obtener categoría por id (admin).</summary>
...

        {
...

            {
                ...
                return CreatedAtAction(nameof(GetByIdAdmin), new { id = created.CategoryId }, created);
        ...
        /// <summary>Eliminar categoría (retorna 409 si tiene artículos activos).</summary>
